...
const Signup = () => {
  return (
    <section class="flex flex-col items-center pt-6 mb-6">
      <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" method="POST">
            ...
            <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Account Type</label>
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">Already have an account? <Link
              class="font-medium text-blue-600 hover:underline dark:text-blue-500" to="/login">Sign in here</Link>
            </p>
          </form>
        </div>
      </div>
